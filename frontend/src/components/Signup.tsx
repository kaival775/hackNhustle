        ...
        <main className="flex-1 bg-white dark:bg-[#1a2c2b] rounded-t-[2.5rem] -mt-10 relative z-20 flex flex-col shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] transition-colors duration-300">
          <div className="w-full max-w-md mx-auto p-6 pt-8 pb-8 flex flex-col h-full">
            <div className="mb-6 space-y-1">
              <h2 className="text-2xl font-bold text-[#111717] dark:text-white">Create Account</h2>
              <p className="text-gray-500 dark:text-gray-400 text-sm">Start your signing journey today.</p>
            </div>
            ...
            <form className="space-y-5 flex-1" onSubmit={handleSubmit}>
              ...
              <div className="relative flex items-center py-2">
                ...
                <span className="flex-shrink-0 mx-4 text-gray-400 text-xs font-medium">Or sign up with</span>
                <div className="flex-grow border-t border-gray-100 dark:border-gray-700" />
              </div>
            ...
            <div className="mt-8 text-center pb-2">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                ...
                <a onClick={() => navigate('/login')} className="font-bold text-coral hover:text-red-500 transition-colors ml-1 inline-flex items-center gap-0.5 group cursor-pointer">
                  Log In
